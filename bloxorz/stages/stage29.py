...
def stage29():
    ...
    arr[0] = [None, None, Tile(T.soft_button, B2, B5), B1[0], B1[1], Tile(), 
                None, None, None, Tile(), B2[0], B2[1], Tile(T.hard_button, B4, [])]
    ...
    arr[3] = [Tile(T.hard_button, B7, B8), B6[0], B6[1]]
    arr[3] += [Tile() for i in range(9)]
    arr[3] += [B3[0], B3[1], Tile(T.hard_button, [SB], [])]
    ...
    arr[6] += [B4[1], Tile(), None, None, Tile(), B5[0], B5[1], Tile(T.soft_button, B6, [])]
    ...
    arr[9] += [Tile(), B8[0], B8[1], 
                Tile(T.soft_button, [B3[0],B3[1]], [B1[0],B1[1],B2[0],B2[1],B5[0],B5[1]])]
