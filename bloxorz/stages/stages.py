...
def stage3():
    ...
    arr[0] = [None for i in range(6), Tile() for i in range(7)]

    arr[1] = [Tile() for i in range(4), None, None, 
              Tile() for i in range(3), None, None, Tile(), Tile()]

    arr[2] = [Tile() for i in range(9), None, None, Tile() for i in range(4)]

    arr[3] = [Tile() for i in range(4), None for i in range(7), 
              Tile(), Tile(), Tile(T.goal), Tile()]
...
def stage4():
    ...
    arr[2] = [Tile() for i in range(4), None for i in range(5), Tile() for i in range(3)]

    arr[3] = [Tile(), Tile(), Tile(), None for i in range(7), Tile(), Tile()]

    arr[4] = [Tile(), Tile(), Tile(), None for i in range(7), Tile(), Tile()]

    arr[5] = [Tile(), Tile(), Tile(), None, None, 
              Tile() for i in range(4), Tile(T.soft_ground) for i in range(5)]

    arr[6] = [Tile(), Tile(), Tile(), None, None, 
              Tile() for i in range(4), Tile(T.soft_ground) for i in range(5)]

    arr[7] = [None for i in range(5), Tile(), Tile(T.goal), Tile(), None, None, 
              Tile(T.soft_ground), Tile(T.soft_ground), Tile(), Tile(T.soft_ground)]

    arr[8] = [None for i in range(5), Tile(), Tile(), Tile(), None, None, 
              Tile(T.soft_ground) for i in range(4)]
...
def stage5():
    ...
    arr[3] = [None, Tile(), Tile(), Tile(T.soft_special_button, B3, []), Tile()]
    ...
    arr[8] = [Tile(), Tile(T.goal), Tile() for i in range(3), B3[0], B3[1]]
...
def stage2():
    ...
    s.save('stage2')
>>>>>>> 54cf9ec46f07b25c6241d6cc0e089f7520371dac
