...
def stage25():
    ...
    arr[2] = [None, None, Tile(), Tile(), Tile(T.soft_button)]
    ...
    arr[7] = [Tile(), Tile(), B, None, None, None, Tile(), Tile()]

    arr[8] = [Tile(), Tile(), B, None, None, None, Tile(), Tile(), Tile(T.soft_button, SB1, B2)]
